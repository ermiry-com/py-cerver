...
static CurlResult multi_single_request_internal (CURL *curl) {
	...
	(void) curl_mime_filedata (field, "./images/cerver.png");
	...
	(void) curl_mime_filedata (field, "./images/banner.png");
	...
	(void) curl_mime_filedata (field, "./images/multiple-segfault-faulthandler.png");

	field = curl_mime_addpart (form);
	(void) curl_mime_name (field, "file-two");
	(void) curl_mime_filedata (field, "./images/multiple-segfault-gdb.png");
