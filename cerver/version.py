...
PYCERVER_VERSION = "0.7.1".encode ('utf-8')
PYCERVER_VERSION_NAME = "Version 0.7.1".encode ('utf-8')
PYCERVER_VERSION_DATE = "09/06/2021".encode ('utf-8')
PYCERVER_VERSION_TIME = "09:28 CST".encode ('utf-8')
