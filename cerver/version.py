...
PYCERVER_VERSION = "0.8.4".encode ('utf-8')
PYCERVER_VERSION_NAME = "Version 0.8.4".encode ('utf-8')
PYCERVER_VERSION_DATE = "05/09/2021".encode ('utf-8')
PYCERVER_VERSION_TIME = "14:37 CST".encode ('utf-8')
