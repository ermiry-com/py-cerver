...
PYCERVER_VERSION = "0.7.3".encode ('utf-8')
PYCERVER_VERSION_NAME = "Version 0.7.3".encode ('utf-8')
PYCERVER_VERSION_DATE = "30/06/2021".encode ('utf-8')
PYCERVER_VERSION_TIME = "20:01 CST".encode ('utf-8')
