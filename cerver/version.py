...
PYCERVER_VERSION = "0.7.6".encode ('utf-8')
PYCERVER_VERSION_NAME = "Version 0.7.6".encode ('utf-8')
PYCERVER_VERSION_DATE = "05/07/2021".encode ('utf-8')
PYCERVER_VERSION_TIME = "15:28 CST".encode ('utf-8')
