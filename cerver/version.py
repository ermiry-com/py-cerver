...
PYCERVER_VERSION = "0.7".encode ('utf-8')
PYCERVER_VERSION_NAME = "Version 0.7".encode ('utf-8')
PYCERVER_VERSION_DATE = "21/05/2021".encode ('utf-8')
PYCERVER_VERSION_TIME = "07:24 CST".encode ('utf-8')
