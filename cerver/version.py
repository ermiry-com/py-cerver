...
PYCERVER_VERSION = "0.7.5".encode ('utf-8')
PYCERVER_VERSION_NAME = "Version 0.7.5".encode ('utf-8')
PYCERVER_VERSION_DATE = "04/07/2021".encode ('utf-8')
PYCERVER_VERSION_TIME = "10:45 CST".encode ('utf-8')
