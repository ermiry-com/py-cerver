...
PYCERVER_VERSION = "0.7.2".encode ('utf-8')
PYCERVER_VERSION_NAME = "Version 0.7.2".encode ('utf-8')
PYCERVER_VERSION_DATE = "28/06/2021".encode ('utf-8')
PYCERVER_VERSION_TIME = "08:45 CST".encode ('utf-8')
