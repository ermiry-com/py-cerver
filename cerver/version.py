...
PYCERVER_VERSION = "0.7.7".encode ('utf-8')
PYCERVER_VERSION_NAME = "Version 0.7.7".encode ('utf-8')
PYCERVER_VERSION_DATE = "13/07/2021".encode ('utf-8')
PYCERVER_VERSION_TIME = "21:23 CST".encode ('utf-8')
