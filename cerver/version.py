...
PYCERVER_VERSION = "0.8.3".encode ('utf-8')
PYCERVER_VERSION_NAME = "Version 0.8.3".encode ('utf-8')
PYCERVER_VERSION_DATE = "04/09/2021".encode ('utf-8')
PYCERVER_VERSION_TIME = "22:25 CST".encode ('utf-8')
