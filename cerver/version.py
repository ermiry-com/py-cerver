...
PYCERVER_VERSION = "0.6.3".encode ('utf-8')
PYCERVER_VERSION_NAME = "Version 0.6.3".encode ('utf-8')
PYCERVER_VERSION_DATE = "10/05/2021".encode ('utf-8')
PYCERVER_VERSION_TIME = "21:57 CST".encode ('utf-8')
