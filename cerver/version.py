...
PYCERVER_VERSION = "0.8".encode ('utf-8')
PYCERVER_VERSION_NAME = "Version 0.8".encode ('utf-8')
PYCERVER_VERSION_DATE = "08/08/2021".encode ('utf-8')
PYCERVER_VERSION_TIME = "22:48 CST".encode ('utf-8')
