...
PYCERVER_VERSION = "0.7.4".encode ('utf-8')
PYCERVER_VERSION_NAME = "Version 0.7.4".encode ('utf-8')
PYCERVER_VERSION_DATE = "03/07/2021".encode ('utf-8')
PYCERVER_VERSION_TIME = "20:23 CST".encode ('utf-8')
