...
PYCERVER_VERSION = "0.6.2".encode ('utf-8')
PYCERVER_VERSION_NAME = "Version 0.6.2".encode ('utf-8')
PYCERVER_VERSION_DATE = "06/05/2021".encode ('utf-8')
PYCERVER_VERSION_TIME = "10:15 CST".encode ('utf-8')
